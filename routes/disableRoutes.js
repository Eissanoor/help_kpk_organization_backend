...
router.get("/get-all-disable", cache("2 minutes"), disableController.getAlldisable)
router.get("/get-all-alter-disable", cache("2 minutes"), disableController.getAllAlterDisable)
...
router.get("/get-all-alter-form-by-user-id/:userId", cache("2 minutes"), disableController.getAllAlterFormByUserId)
